...
<!DOCTYPE html>
    ...
    <head >   
        <meta charset="utf-8" />
        <meta name="description" content="Create an Index"  />
    ...
    <body class= "background">
        ...
        <section class="table">
            <tr>
                <td>
                    <img src="images/img1.jpg" height="200" width="350"/>
                </td>
                <td>
                    <img src="images/img2.jpg" height="200" width="200"/>
                </td><td>
                    <img src="images/img3.jpg" height="200" width="350"/>
                </td>
            </tr>
        </section>
        <section>
            <tr>
                <td>
                    <img src="images/img4.jpg" height="200" width="350"/>
                </td>
                <td>
                    <img src="images/img5.jpg" height="200" width="200"/>
                </td><td>
                    <img src="images/img6.jpg" height="200" width="350"/>
                </td>
            </tr>
        </section>
        </section>
